...
class DocumentationMobileCTController extends Controller{
    ...
    public function index(){
        $documents = Documentation::query()->where('type', Documentation::MOBILE_CT_TYPE)->orderBy('sort')->get();

        return view("Documentation::mobile_ct.index", compact('documents'));
    }
    ...
    public function getCreate(Request $request){
        ...
        return $this->renderAjax("Documentation::mobile_ct._form");
    }
    ...
    public function postCreate(DocumentationRequest $request){
        ...
        try {
            ...
            $data['type'] = Documentation::MOBILE_CT_TYPE;
    ...
    public function getView($id){
        ...
        return $this->renderAjax("Documentation::mobile_ct._content", compact('document'));
    }
    ...
    public function getDocumentation(){
        ...
        return view("Documentation::mobile_ct.master", compact('documents'));
    }
}
