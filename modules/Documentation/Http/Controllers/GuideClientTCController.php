...
class GuideClientTCController extends Controller{
    ...
    public function index(){
        $documents = Documentation::query()->where('type', Documentation::CLIENT_GUIDE_CT)->orderBy('sort')->get();

        return view("Documentation::guide_client_tc.index", compact('documents'));
    }
    ...
    public function getCreate(Request $request){
        ...
        return $this->renderAjax("Documentation::guide_client_tc._form");
    }
    ...
    public function postCreate(DocumentationRequest $request){
        ...
        try {
            ...
            $data['type'] = Documentation::CLIENT_GUIDE_CT;
    ...
    public function getView($id){
        ...
        return $this->renderAjax("Documentation::guide_client_tc._content", compact('document'));
    }
    ...
    public function getDocumentation(){
        ...
        return view("Documentation::guide_client_tc.master", compact('documents'));
    }
}
