...
class GuideClientController extends Controller{
    ...
    public function index(){
        $documents = Documentation::query()->where('type', Documentation::CLIENT_GUIDE)->orderBy('sort')->get();

        return view("Documentation::guide_client.index", compact('documents'));
    }
    ...
    public function getCreate(Request $request){
        ...
        return $this->renderAjax("Documentation::guide_client._form");
    }
    ...
    public function postCreate(DocumentationRequest $request){
        ...
        try {
            ...
            $data['type'] = Documentation::CLIENT_GUIDE;
    ...
    public function getView($id){
        ...
        return $this->renderAjax("Documentation::guide_client._content", compact('document'));
    }
    ...
    public function getDocumentation(){
        ...
        return view("Documentation::guide_client.master", compact('documents'));
    }
}
