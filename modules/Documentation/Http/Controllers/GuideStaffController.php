...
class GuideStaffController extends Controller{
    ...
    public function index(){
        $documents = Documentation::query()->where('type', Documentation::STAFF_GUIDE)->orderBy('sort')->get();

        return view("Documentation::guide_staff.index", compact('documents'));
    }
    ...
    public function getCreate(Request $request){
        ...
        return $this->renderAjax("Documentation::guide_staff._form");
    }
    ...
    public function postCreate(DocumentationRequest $request){
        ...
        try {
            ...
            $data['type'] = Documentation::STAFF_GUIDE;
    ...
    public function getView($id){
        ...
        return $this->renderAjax("Documentation::guide_staff._content", compact('document'));
    }
    ...
    public function getDocumentation(){
        ...
        return view("Documentation::guide_staff.master", compact('documents'));
    }
}
