...
class GuideStaffTCController extends Controller{
    ...
    public function index(){
        $documents = Documentation::query()->where('type', Documentation::STAFF_GUIDE_CT)->orderBy('sort')->get();

        return view("Documentation::guide_staff_tc.index", compact('documents'));
    }
    ...
    public function getCreate(Request $request){
        ...
        return $this->renderAjax("Documentation::guide_staff_tc._form");
    }
    ...
    public function postCreate(DocumentationRequest $request){
        ...
        try {
            ...
            $data['type'] = Documentation::STAFF_GUIDE_CT;
    ...
    public function getView($id){
        ...
        return $this->renderAjax("Documentation::guide_staff_tc._content", compact('document'));
    }
    ...
    public function getDocumentation(){
        ...
        return view("Documentation::guide_staff_tc.master", compact('documents'));
    }
}
