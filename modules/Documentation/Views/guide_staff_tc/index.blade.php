        ...
        <div class="breadcrumb-line">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">{{ trans("員工指南") }}</a></li>
                </ol>
            </nav>
        </div>
        <div id="head-page" class="d-flex justify-content-between">
            <div class="page-title"><h3>{{ trans("員工指南") }}</h3></div>
            @if(Auth::user()->isAdmin())
                <div class="group-btn">
                    <a href="{{ route("get.guide_staff_tc.create") }}"
                       class="btn btn-main-color"
                       data-toggle="modal"
                       data-title="{{ trans('員工指南') }}"
                ...
                <div class="row">
                    <div class="col-2" id="list-title-tab">
                        <div class="nav flex-column nav-pills" id="list-title" role="tablist"
                            ...
                            @foreach($documents as $key => $document)
                                <a class="nav-link document-title @if($key === 0) active @endif" data-toggle="pill"
                                   href="{{ route("get.guide_staff_tc.view", $document->id) }}">
                        ...
                        <div id="nestable-tab" style="display: none">
                            ...
                            <form action="{{route("post.guide_staff_tc.sort")}}" method="post"
                                        ...
                                        <div class="card-body" style="min-height: 800px">
                                            <div class="content">
                                                <div class="view-content">
                                                    @if(Auth::user()->isAdmin())
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route("get.guide_staff_tc.delete", $document->id) }}"
                                                ...
                                                <div class="edit-content" style="display: none">
                                                    <form
                                                        action="{{ route("post.guide_staff_tc.update", $document->id) }}"
