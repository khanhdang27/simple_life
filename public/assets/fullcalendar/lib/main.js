...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var t$1, u$1, r$1, i$1 = [], c$1 = n.__b, f$1 = n.__r, e$1 = n.diffed, a$1 = n.__c, v$1 = n.unmount;
    ...
    (w$1.prototype = new d).isPureReactComponent = !0, w$1.prototype.shouldComponentUpdate = function (n, t) {
        return g$2(this.props, n) || g$2(this.state, t)
    };
    var R = n.__b;
    n.__b = function (n) {
    ...
    function L$1(n) {
        ...
        }), n.__c.__H = null), (n = S$1({}, n)).__c = null, n.__k = n.__k && n.__k.map(L$1)), n
    }
    ...
    n.__e = function (n, t, e) {
        ...
        var u = M$1(r.__v), o = !1, i = function () {
        ...
        var c = function () {
            var n;
            if (!--r.__u) for (r.__v.__k[0] = U(r.state.__e), r.setState({__e: r.__b = null}); n = r.t.pop();) n.forceUpdate();
        };
        !0 === t.__h || r.__u++ || r.setState({__e: r.__b = r.__v.__k[0]}), n.then(i, i);
    }, F.prototype.componentWillUnmount = function () {
        this.t = [];
    }, F.prototype.render = function (n, t) {
        this.__b && (this.__v.__k && (this.__v.__k[0] = L$1(this.__b)), this.__b = null);
        var e = t.__e && v(p, null, n.fallback);
        return e && (e.__h = null), [v(p, null, t.__e ? null : n.children), e]
    };
    ...
    function j$2(n) {
        var t = this, e = n.i, r = v(W, {context: t.context}, n.__v);
    ...
    function P$1(n, t) {
        return v(j$2, {__v: n, i: t})
    }

    (I$1.prototype = new d).__e = function (n) {
        var t = this, e = M$1(t.__v), r = t.o.get(n);
    ...
    n.event = function (n) {
        return Y && (n = Y(n)), n.persist = $$1, n.isPropagationStopped = q, n.isDefaultPrevented = G, n.nativeEvent = n
    };
    var J, K = {
        configurable: !0, get: function () {
            return this.class
    ...
    n.vnode = function (n) {
        ...
        if ("string" == typeof t) {
            for (var u in r = {}, e) {
                var o = e[u];
                "defaultValue" === u && "value" in e && null == e.value ? u = "value" : "download" === u && !0 === o ? o = "" : /ondoubleclick/i.test(u) ? u = "ondblclick" : /^onchange(textarea|input)/i.test(u + t) && !B$1.test(e.type) ? u = "oninput" : /^on(Ani|Tra|Tou|BeforeInp)/.test(u) ? u = u.toLowerCase() : V.test(u) ? u = u.replace(/[A-Z0-9]/, "-$&").toLowerCase() : null === o && (o = void 0), r[u] = o;
            }
            "select" == t && r.multiple && Array.isArray(r.value) && (r.value = b(e.children).forEach(function (n) {
    ...
    */
    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        SegHierarchy.prototype.splitEntry = function (entry, barrier, hiddenEntries) {
            ...
            if (partCnt) {
                hiddenEntries.push.apply(hiddenEntries, __spreadArrays([__assign(__assign({}, entry), {
    ...
    var TimeColMoreLink = /** @class */ (function (_super) {
        ...
        TimeColMoreLink.prototype.render = function () {
            ...
            return (createElement(MoreLinkRoot, {
                ...
                defaultContent: renderMoreLinkInner$1,
                extraDateSpan: props.extraDateSpan,
                dateProfile: props.dateProfile,
                todayRange: props.todayRange,
                popoverContent: function () {
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.renderPositionedFgSegs = function (segs, // if not mirror, needs to be sorted
            ...
            var _c = isMirror ? computeFgSegPlacements(segInputs) : // don't use memoized
                this.computeFgSegPlacements(segInputs, eventOrderStrict, eventMaxStack), segRects = _c.segRects,
